...
const Dashboard = () => {
  const {context,currency}=useContext(AppContext)
  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 mid:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        ...
        <div>
           ...
           <div className='flex flfex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20'>
